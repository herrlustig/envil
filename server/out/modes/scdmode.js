...
exports.getSuperColliderMode = void 0;
                ...
                if (callStart >= 0) {
                    ...
                    if (dotM) {
                        ...
                        if (bareM) {
                            ...
                            if (classSigs)
                                sig = classSigs['new'] ?? Object.values(classSigs)[0];
                        }
                    }
                    if (sig) {
        ...
        doSignatureHelp(document, position) {
            ...
            if (dotMatch) {
                ...
                if (sig) {
                    ...
                    if (namedMatch) {
                        const idx = sig.params.findIndex((p) => p.name === namedMatch[1]);
                        if (idx >= 0)
                            activeParam = idx;
                    }
                    return {
...
exports.getSuperColliderMode = getSuperColliderMode;
//# sourceMappingURL=scdmode.js.map